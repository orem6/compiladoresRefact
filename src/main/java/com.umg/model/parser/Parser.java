package com.dataquery.sqlcompiler.model.parser;
...
import com.dataquery.sqlcompiler.model.lexer.TokenType;
...
public class Parser {
    ...
    private ASTNode parseStatement() {
        ...
        if (current.getType() != TokenType.KEYWORD) {
            errorCollector.addError(new com.dataquery.sqlcompiler.model.error.CompilerError(
    ...
    private ASTNode parseSelect() {
        ...
        return new com.dataquery.sqlcompiler.model.ast.SelectStatement();
    }
    ...
    private ASTNode parseInsert() {
        ...
        consumeToken(TokenType.RPAREN);
        consumeToken(TokenType.SEMICOLON);
        return new com.dataquery.sqlcompiler.model.ast.InsertStatement();
    }
    ...
    private ASTNode parseUpdate() {
        ...
        consumeToken(TokenType.SEMICOLON);
        return new com.dataquery.sqlcompiler.model.ast.UpdateStatement();
    }
    ...
    private ASTNode parseDelete() {
        ...
        consumeToken(TokenType.SEMICOLON);
        return new com.dataquery.sqlcompiler.model.ast.DeleteStatement();
    }
    ...
    private ASTNode parseCreateTable() {
        ...
        consumeToken(TokenType.RPAREN);
        consumeToken(TokenType.SEMICOLON);
        return new com.dataquery.sqlcompiler.model.ast.CreateTableStatement();
    }
    ...
    private ASTNode parseDropTable() {
        ...
        consumeToken(TokenType.IDENTIFIER);
        consumeToken(TokenType.SEMICOLON);
        return new com.dataquery.sqlcompiler.model.ast.DropTableStatement();
    }
